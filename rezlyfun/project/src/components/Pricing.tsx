      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            ...
            <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent"> odgovara vama</span>
          </h2>
        ...
        <div className="text-center mt-16">
          <p className="text-gray-600 mb-6">
            Trebate prilagođeno rješenje? Kontaktirajte nas za personaliziranu ponudu.
          </p>
          <button className="inline-flex items-center px-8 py-4 border-2 border-gray-300 text-gray-700 font-semibold rounded-xl hover:border-blue-500 hover:text-blue-600 transition-all duration-300">
